...
namespace FlightInspectionApp
{
    ...
    class AdvancedDetailsModel
    {
        ...
        //private string selectedAnomalyShape;
        ...
        public void setSelectedColumns()
        {
            ...
            ctd.setSelectedName(SelectedItem);
                ...
                correlativeFeature = ctd.getCorrelativeFeature(@"C:\peleg\MitkademTwo\FlightInspectionApp-first-stepping-stone\FlightInspectionApp\FlightInspectionApp\bin\x86\Debug\Debugnew_anomaly_flight.csv", minX, maxX);
